        ...
        <div class="inner-card p-10 min-h-[580px] flex flex-col justify-center">
            ...
            <form class="space-y-4">
                <div class="relative border-b-2 border-gray-200 focus-within:border-green-400 transition-colors">
                    ...
                    <input type="text" placeholder="Full Name" class="w-full pl-8 pb-2 outline-none bg-transparent" required>
                </div>
                <div class="relative border-b-2 border-gray-200 focus-within:border-green-400 transition-colors">
                ...
                <div class="relative border-b-2 border-gray-200 focus-within:border-green-400 transition-colors">
                    ...
                    <input type="password" placeholder="Password**" class="w-full pl-8 pb-2 outline-none bg-transparent" required>
                </div>
                ...
                <div class="text-center pt-4">
                    ...
                    <a href="login-01" class="text-red-500 text-sm font-bold border-b border-red-500">login</a>
                </div>
            </form>
        </div>
    </div>
